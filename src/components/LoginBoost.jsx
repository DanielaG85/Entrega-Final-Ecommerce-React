      ...
      <div className='d-flex flex-column justify-content-center align-items-center min-vh-100'>
        <form onSubmit={iniciarSesionEmailPass} className="p-4 border rounded shadow">
          ...
          <div className="mb-3">
           ...
           <button style={{marginTop:"2px"}} className="btn btn-dark w-100" onClick={handleShow}>Registrate</button>
           <button style={{marginTop:"2px"}} className="btn btn-dark w-100" onClick={logInGmail}>Iniciar Sesión con Gmail</button>
        </form>        
      </div>
    )
  }if(!user && !show){
